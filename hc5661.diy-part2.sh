...
sed -i 's/192.168.1.1/192.168.6.100/g' package/base-files/files/bin/config_generate
sed -i 's/OpenWrt/SZ-MB_HC5661/g' package/base-files/files/bin/config_generate
